...
protocol PickColorViewDelegate: class {
    func successfulEditting(isSetMainColor: Bool, maincolor: ColorModel)
}

class PickColorViewController: UIViewController, UITextFieldDelegate {

    weak var pickColorDelegate: PickColorViewDelegate?
    ...
    @IBAction func doneButtonPressed(_ sender: UIButton) {
        ...
        pickColorDelegate?.successfulEditting(isSetMainColor: isSetMainColor, maincolor: mainColor)
    }
    ...
    // True: edit main color; False: add material color 
    var isSetMainColor = false
...
extension PickColorViewController: ColorPageViewControllerDelegate {
...
extension PickColorViewController: CustomCameraDelegate {
